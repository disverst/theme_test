                        ...
                        <div className="format">
                            <div className="format-sub-text">
                                <p className="about-para">
                                    Киевская студия WebDelnica, предоставляет комплексные IT услуги для православных церквей. Узконаправленность нашей деятельности позволяет нам предоставлять максимально качественный продукт в короткие сроки и точно реализовать, все Ваши пожелания и требования к сайту.
                                </p>
                                <p className="about-para">
